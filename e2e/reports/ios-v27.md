# E2E Отчёт: iOS v27 — Верификация APIService и NotesViewModel
...
- **Сценарии:** полностью воспроизводимы curl-командами из [ios-notes-v27.md](../scenarios/ios-notes-v27.md)
